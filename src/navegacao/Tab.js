...
export default props => {
    ...
    return (
        <tab.Navigator
            ...
            <tab.Screen name="PerfilStack" component={SubStack} initialParams={{ Tela: "Perfil", id_usu: props.route.params.id_usu, id_usu_perfil: props.route.params.id_usu }} options={{unmountOnBlur: true}} />
        </tab.Navigator>
    )
}